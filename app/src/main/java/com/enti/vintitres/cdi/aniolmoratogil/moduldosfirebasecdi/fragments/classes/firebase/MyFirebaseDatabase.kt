...
import com.enti.vintitres.cdi.aniolmoratogil.moduldosfirebasecdi.fragments.classes.models.DbBaseData
        ...
        table
            ...
            .addOnSuccessListener { documentSnapshot ->
                ...
                data?.let { data ->
                    ...
                    val exception = java.lang.Exception("Error on Parse Firesttore DocumentSnapshot")
                    FB.crashlytics.logError(exception){
                        key("id", id)
                        key("table", tableName)
